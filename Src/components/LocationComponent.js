  ...
  return (
    <View style={[style, CustomAlignItems]}>
      ...
      <View style={[{ justifyContent: 'space-between', flexDirection: 'row', alignItems: 'center', backgroundColor: backgroundColor, width: width ? width : SCREEN_WIDTH * .95 }, CustomFlexDirection]}>
        ...
        <IconComponent image={CompassNorthEast} style={{ height: SCREEN_WIDTH * .08, width: SCREEN_WIDTH * .08, }} imageStyle={{ height: SCREEN_WIDTH * .05, width: SCREEN_WIDTH * .05, }} onPress={() => MapRef.current?.show()} />
      </View>
      <CustomActionSheet />
    </View>

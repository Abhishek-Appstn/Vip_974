...
const ItemLayout = ({ buttonTitle, children, size, colors, onPress, screenname, padding, type }) => {
  ...
  return (
    <View style={{ backgroundColor: Colors.Green1, flex: 1 }}>
      <View style={{ backgroundColor: colors ? colors : Colors.Black, flex: 1, width: SCREEN_WIDTH, borderRadius: 15, overflow: "hidden", borderTopRightRadius: 0, borderTopLeftRadius: 0 }}>
